...
public class SchemaMetaIT {
    ...
    public void commentsNullTableComment() throws Exception {
        ...
        new DatabaseServiceFactory(sqlService).simple(config, false).gatherSchemaDetails(databaseWithSchemaMeta, schemaMeta, progressListener);
    ...
    public void commentsAreReplacedWithReplaceComments() throws Exception {
        ...
        new DatabaseServiceFactory(sqlService).simple(config, false).gatherSchemaDetails(database, schemaMeta, progressListener);
