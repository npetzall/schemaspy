...
@SpringBootTest
@DirtiesContext
public class InformixIndexCompFKXMLIT {

    private static URL expectedXML = InformixIndexCompFKXMLIT.class.getResource("/integrationTesting/informixIndexXMLIT/expecting/test.informix.xml");
    private static URL expectedDeletionOrder = InformixIndexCompFKXMLIT.class.getResource("/integrationTesting/informixIndexXMLIT/expecting/deletionOrder.txt");
    private static URL expectedInsertionOrder = InformixIndexCompFKXMLIT.class.getResource("/integrationTesting/informixIndexXMLIT/expecting/insertionOrder.txt");
    ...
    public static JdbcContainerRule<InformixContainer> jdbcContainerRule =
            new JdbcContainerRule<>(() -> new InformixContainer(InformixContainer.IMAGE + ":14.10.FC3DE"))
                    .assumeDockerIsPresent()
                    .withAssumptions(assumeDriverIsPresent())
                    .withInitScript("integrationTesting/informixIndexXMLIT/dbScripts/informixcompfk.sql");
