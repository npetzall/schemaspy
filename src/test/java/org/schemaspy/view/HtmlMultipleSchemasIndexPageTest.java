...
class HtmlMultipleSchemasIndexPageTest {
    ...
    void multiMainIndexShouldHaveDescription() {
        MustacheCompiler mustacheCompiler = new MustacheCompiler("withComment", null, commandLineArguments.getHtmlConfig(), false, dataTableConfig, new TablePathRegistry());
    ...
    void multiMainIndexShouldNOTHaveDescription() {
        MustacheCompiler mustacheCompiler = new MustacheCompiler("noComment", null, commandLineArguments.getHtmlConfig(), false, dataTableConfig, new TablePathRegistry());
        HtmlMultipleSchemasIndexPage htmlMultipleSchemasIndexPage = new HtmlMultipleSchemasIndexPage(mustacheCompiler);
        StringWriter actual = new StringWriter();
