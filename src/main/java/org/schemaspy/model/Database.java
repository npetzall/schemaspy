...
public class Database {
    ...
    public Database(Config config, DatabaseMetaData meta, String name, String catalog, String schema, SchemaMeta schemaMeta) throws SQLException, MissingResourceException {
        this.config = config;
        this.meta = meta;
