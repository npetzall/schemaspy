...
public class DotConnectorFinder {
    ...
    public DotConnectorFinder(DotConfig config) {
    ...
    private Set<DotConnector> getRelatedConnectors(TableColumn column, Table targetTable, boolean includeExcluded, boolean includeImplied) {
        ...
        for (TableColumn parentColumn : column.getParents()) {
            ...
            if (!implied || includeImplied) {
                relatedConnectors.add(new DotConnector(parentColumn, column, implied, config.bottomJustify()));
            }
        }
        ...
        for (TableColumn childColumn : column.getChildren()) {
            ...
            if (!implied || includeImplied) {
                relatedConnectors.add(new DotConnector(column, childColumn, implied, config.bottomJustify()));
            }
        }
