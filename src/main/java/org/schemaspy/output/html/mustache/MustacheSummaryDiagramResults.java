...
public class MustacheSummaryDiagramResults {
    ...
    private final List<MustacheDiagram> diagrams;
    ...
    public MustacheSummaryDiagramResults(List<MustacheDiagram> diagrams, WriteStats stats, boolean hasRealRelationships, List<ImpliedForeignKeyConstraint> impliedConstraints) {
    ...
    public List<MustacheDiagram> getDiagrams() {
        return diagrams;
    }
