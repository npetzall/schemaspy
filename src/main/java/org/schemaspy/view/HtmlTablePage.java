...
public class HtmlTablePage {
    ...
    private final MustacheTableDiagramFactory mustacheTableDiagramFactory;

    public HtmlTablePage(MustacheCompiler mustacheCompiler, SqlAnalyzer sqlAnalyzer, MustacheTableDiagramFactory mustacheTableDiagramFactory) {
        this.mustacheCompiler = mustacheCompiler;
        this.sqlAnalyzer = sqlAnalyzer;
        this.mustacheTableDiagramFactory = mustacheTableDiagramFactory;
    }
    ...
    public void write(Table table, File outputDir, WriteStats stats, Writer writer) throws IOException {
        ...
        List<MustacheDiagram> diagrams = mustacheTableDiagramFactory.generateTableDiagrams(table, stats);
